...
# Create S-information calculator
...
sinfo.initialise(X.shape[1])  # Only number of variables
sinfo.setObservations(JArray(JDouble, 2)(X.tolist()))
value = sinfo.computeAverageLocalOfObservations()
print("S-Information:", value)
